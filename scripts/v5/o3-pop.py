#!/usr/bin/env python3
"""O3 gate 16 -- rim / reflection pop over the recorded sequences.
...
exactly the post-hoc re-interpretation §七 forbids this round. The static
...
Usage: o3-pop.py [--recordings=<dir>] [--out=<json>]
"""
...
def main() -> int:
    opts = {"recordings": REPO / "artifacts/optics-o3/recordings",
            "out": REPO / "artifacts/optics-o3/recordings/pop.json"}
    for a in sys.argv[1:]:
    ...
    result = {
        "what": "O3 gate 16 -- rim / reflection pop, scored on the candidate "
