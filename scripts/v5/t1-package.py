#!/usr/bin/env python3
"""
Seal the private T1 review package.
...
ZIP = Path("qa-v5/private/t1-review.zip")
TEXT = ["README.md", "MANIFEST.json", "target-typography-contract.json",
...
DOCS = ["docs/v5/SOURCE_EXACT_TYPOGRAPHY.md", "docs/v5/CURRENT_STATUS.md"]
...
if __name__ == "__main__":
    ...
    payload = {
        ...
        "note": "qa-v5/t1/MANIFEST.json is also included and describes the public tree; the two "
