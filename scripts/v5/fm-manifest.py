#!/usr/bin/env python3
"""Final Motion §九/§十一 -- the public manifest, and the limits check.
...
Usage: fm-manifest.py [--dir=qa-v5/final-motion]
"""
...
BASE = "d48fc6f53d3e21b265db00e60d88b7d02fe0c909"
...
def main() -> int:
    ...
    d = REPO / args.get("dir", "qa-v5/final-motion")
    ...
    head = captured
    doc = {
        "round": "MirrorWeb V5 -- Final Motion Convergence Sprint",
        ...
        "baseline": f"{BASE} (Visual Convergence Sprint 2)",
        ...
        "privatePackage": {
            "path": "qa-v5/private/v5-final-motion.zip",
        ...
        "declaredResiduals": [r["residual"] for r in state["declaredResiduals"]],
    }
    limits = {
